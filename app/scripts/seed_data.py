...
async def seed_database():
    ...
    async with async_session() as session:
        ...
        # ========== САЛОНЫ ==========
        s1 = Salon(name="Брутальный", description="Мужские стрижки, борода, уход", address="Москва, ул. Тверская, 15", latitude=55.761859, longitude=37.606138, phone="+79991234567", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Europe/Moscow", working_hours=WORK_WEEK)
        s2 = Salon(name="Classic", description="Классические мужские стрижки", address="Санкт-Петербург, Невский пр., 22", latitude=59.934280, longitude=30.335099, phone="+78121234567", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Europe/Moscow", working_hours=WORK_DAILY)
        s3 = Salon(name="Имидж", description="Женские и мужские стрижки, окрашивание", address="Москва, пр. Мира, 45", latitude=55.779438, longitude=37.636928, phone="+74959876543", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Europe/Moscow", working_hours=WORK_WEEK)
        s4 = Salon(name="Гламур", description="Маникюр, педикюр, наращивание", address="Санкт-Петербург, Большой пр. П.С., 10", latitude=59.962264, longitude=30.308452, phone="+78123334455", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Europe/Moscow", working_hours=WORK_DAILY)
        s5 = Salon(name="Элегант", description="Стрижки, укладки, уход за волосами", address="Казань, ул. Баумана, 33", latitude=55.792752, longitude=49.121467, phone="+78432987654", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Europe/Moscow", working_hours=WORK_WEEK)
        s6 = Salon(name="Стиль", description="Современные стрижки и окрашивание", address="Екатеринбург, ул. Ленина, 10", latitude=56.838926, longitude=60.605704, phone="+73432987654", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Asia/Yekaterinburg", working_hours=WORK_DAILY)
        s7 = Salon(name="Эстетика", description="Услуги бровиста и визажиста", address="Новосибирск, пр. Красный, 20", latitude=55.030204, longitude=82.920430, phone="+73832987654", rating=0.0, reviews_count=0, moderation_status=SalonModerationStatus.APPROVED, timezone="Asia/Novosibirsk", working_hours=WORK_SHORT)
