...
async def render_analytics_tab(db: AsyncSession, salon, master_ids):
    ...
    <div id="tab-analytics" class="tab-content">
        <div class="analytics-kpi">
            <div class="kpi-card">
                <div class="kpi-label">{ICON_RUBLE_SIGN} Выручка за неделю</div>
        ...
        <div class="card" style="margin-bottom:1.5rem">
            <h3 style="margin-bottom:0.5rem">{ICON_TRENDING_UP} Выручка по дням</h3>
            <div class="legend">
        ...
        <div class="card">
            <h3 style="margin-bottom:1rem">{ICON_STAR_FILLED} Топ услуг по выручке</h3>
            <table>
                <thead>
